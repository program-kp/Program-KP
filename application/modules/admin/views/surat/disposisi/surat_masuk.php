...
<div class="page">
	<div class="page-header">
		<h1 class="page-title">Disposisi Surat Masuk</h1>
		<ol class="breadcrumb">
		...
		<div class="panel">
			...
			<div class="panel-heading">
				<h3 class="panel-title">Disposisi Surat Masuk
					<small>Berisi Data Disposisi Surat Masuk yang ada di DKP3 Kota Banjarbaru</small>
				</h3>
			</div>
...
<div class="modal-dialog modal-simple modal-center">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><span id=judul>Tambah</span> Disposisi Surat Masuk</h4>
		</div>
...
<script>
	...
	function edit(no)
	{
		...
		$.ajax({
			url : "<?php echo base_url()?>admin/disposisi/dataedit/s/"+kode_disposisi,
			type : 'POST',
			dataType:'json',
			success: function(data){
				if (data.hasil=='error') {
