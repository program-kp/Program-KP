	...
	<div class="page-content container-fluid">
		...
		<div class="row" data-plugin="matchHeight" data-by-row="true">
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Surat Masuk Hari Ini
						</h3>
					</div>
					<div class="panel-body">
						<!-- <button id="notify">Tes</button> -->
			...
			<div class="col-md-6">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Undangan Masuk Hari Ini
						</h3>
					</div>
					<div class="panel-body">
						<!-- <button id="notify">Tes</button> -->
...
<script>
	...
	function dataTableJadwal()
	{
		table_jadwal = $('#tabel_jadwal').DataTable({
			"ajax": {
				"url": '<?php echo base_url()?>bidang/dashboard/view_jadwal/',
				"type": "POST",
				"cache": true,
			},
			"dom": 'tip',
	...
	function dataTableSuratDis($nourut)
	{
		table_surat_dis = $('#tabel_surat_dis').DataTable({
			"ajax": {
				"url": '<?php echo base_url()?>bidang/dashboard/view_surat_dis/'+$nourut,
				"type": "POST",
				"cache": true,
			},
			"dom": 'ltip',
	...
	function dataTableUndanganDis($nourut)
	{
		table_undangan_dis = $('#tabel_undangan_dis').DataTable({
			"ajax": {
				"url": '<?php echo base_url()?>bidang/dashboard/view_undangan_dis/'+$nourut,
				"type": "POST",
				"cache": true,
			},
			"dom": 'ltip',
	...
	function dataTableSurat($date = null)
	{
		table_surat = $('#tabel_surat').DataTable({
			"ajax": {
				"url": '<?php echo base_url()?>bidang/dashboard/view_surat',
				"type": "POST",
				"cache": true,
			},
			"dom": 'ltip',
	...
	function dataTableUndangan()
	{
		table_undangan = $('#tabel_undangan').DataTable({
			"ajax": {
				"url": '<?php echo base_url()?>bidang/dashboard/view_undangan',
				"type": "POST",
				"cache": true,
			},
			"dom": 'ltip',
	...
	function info_surat(no)
	{
		...
		$.ajax({
			url : "<?php echo base_url()?>bidang/surat_masuk/dataedit/"+nourut,
			type : 'POST',
			dataType:'json',
			cache: true,
			success: function(data){
